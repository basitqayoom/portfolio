...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "py-3 backdrop-blur-lg bg-background/80 shadow-sm" : "py-5 bg-transparent"}`}
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-primary mr-2 dark:text-white bg-transparent">
              B.
            </div>
          </a>
      ...
      <div
        id="mobile-menu"
        className={`md:hidden fixed top-0 right-0 h-screen w-64 bg-background shadow-xl transform transition-transform ease-in-out duration-300 pt-16 ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"}`}
      >
