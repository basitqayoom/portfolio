...
const StatCard = ({ value, label, className }: StatCardProps) => {
  ...
  return (
    <Card
      ref={ref}
      className={cn("border-none shadow-none glass-card", className)}
    >
      <CardContent className="p-6">
        <p className="text-3xl font-bold mb-1">
          {inView ? count + (value.includes("%") ? "%" : "+") : "0"}
        </p>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-muted-foreground text-lg text-balance">
            Software Development Engineer with 2 years of experience in building
          ...
          <div className="order-2 lg:order-1">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Expert in React, Next.js, and Micro-Frontend architectures.
                Proven track record in optimizing performance, reducing costs,
                and leading system improvements. Skilled in CI/CD pipelines,
                component libraries, scalable web solutions, and DevOps
                practices. Passionate about code quality, best practices, and
