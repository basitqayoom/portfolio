...
const ContactSection = () => {
  ...
  useEffect(() => {
    ...
    const elementsToAnimate =
      sectionRef.current?.querySelectorAll(".animated-element");
    ...
    <section id="contact" className="py-24 bg-secondary/50" ref={sectionRef}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div
            className="space-y-8 animated-element"
          ...
          >
            ...
            <div className="pt-4">
              ...
              <p className="text-muted-foreground mb-6">
                Follow me on social media or check out my profiles on
          ...
          <div
            className="glass-card rounded-2xl p-8 animated-element"
